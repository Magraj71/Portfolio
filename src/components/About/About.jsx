...
const About = () => {
  return (
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center md:gap-x-12">
        {/* Left Side */}
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            ...
            I’ve built RESTful APIs with Node.js and Express, and I’m comfortable working
            with MongoDB and SQL databases to power full-stack applications.
          </p>
          {/* Resume Button */}
          <a
            href={resume}
            ...
            className="inline-block text-white py-3 px-6 rounded-full mt-5 text-lg font-bold transition duration-300 transform hover:scale-105"
            style={{
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          ...
          >
            <img
              src={Maggu}
              alt="Magraj Jakhar"
              className="mr-5 w-full h-full rounded-full object-cover drop-shadow-[0_10px_20px_rgba(130,69,236,0.5)]"
            />
          </Tilt>
        </div>
      </div>
